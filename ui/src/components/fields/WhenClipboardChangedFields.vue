...
// below.
defineProps<{ strandId: string; path: InstrPath; instruction: Extract<InstructionDto, { type: 'WhenClipboardChanged' }> }>();
</script>

<template>
  <ClipboardCheck />
  <span class="instruction-label when-ran-label">When Clipboard Changes</span>
</template>
