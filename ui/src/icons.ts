...
export const INSTRUCTION_TYPE_ICONS: Record<InstructionType, IconName> = {
  ...
  WhenClipboardChanged: 'clipboard-check',
  Wait: 'clock',
  Text: 'text-cursor',
  Key: 'key',
...
export const INSTRUCTION_TYPE_LABELS: Record<InstructionType, string> = {
  ...
  WhenClipboardChanged: 'When Clipboard Changes',
  Wait: 'Wait',
  Text: 'Text',
  Key: 'Key',
  Button: 'Mouse Button',
  ...
  DeleteOfList: 'Delete List Item',
  DeleteAllOfList: 'Clear List',
  ShiftList: 'Shift List',
  InsertIntoList: 'Insert into List',
  ReplaceItemOfList: 'Replace List Item',
